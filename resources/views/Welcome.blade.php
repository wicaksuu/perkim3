    ...
    <section class="hero-section padding">
        <div class="container">
            <div class="hero-content text-center">
                ...
                <p>Business is the activity of making money.</p>
            ...
            <div class="row about-wrap d-flex align-items-center">
                <div class="col-lg-6 xs-padding">
                    <div class="about-content">
                        <h2>Make is a different kind of architecture practice.</h2>
                        <p>Arkit is a different kind of architecture practice. Founded by LoganCee in 1991, we’re an
                            employee-owned firm pursuing a democratic design process that values everyone’s input.</p>
                        <ul class="about-list">
                            <li><i class="fas fa-check"></i>We are confident about our projects.</li>
                            <li><i class="fas fa-check"></i>We always try our best.</li>
                            <li><i class="fas fa-check"></i>Out dadicated team is very helpful.</li>
                            <li><i class="fas fa-check"></i>We provide high quality design services.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 xs-padding">
                    <div class="about-slider-wrap">
                        <div id="about-carousel" class="about-carousel carousel-nav owl-carousel">
                            <img src="img/about-slide-1.jpg" alt="img">
                            <img src="img/about-slide-2.jpg" alt="img">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-sm-6 padding-15">
                    <div class="service-box">
                        ...
                        <div class="service-info">
                            <h3>Architecture</h3>
                            <p>We offer a fully integrated service that complements the architectural concept, we ensure
                                all projects.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div id="projects-carousel" class="projects-carousel owl-carousel">
                <div class="project-item">
                    ...
                    <a href="img/project-1.jpg" class="view-icon img-popup" data-gall="myGallery"> <i
                ...
                <div class="project-item">
                    ...
                    <div class="overlay"></div>
                    <a href="img/project-2.jpg" class="view-icon img-popup" data-gall="myGallery"> <i
                            class="fas fa-expand"></i></a>
                    <div class="projects-content">
                ...
                <div class="project-item">
                    ...
                    <div class="overlay"></div>
                    <a href="img/project-3.jpg" class="view-icon img-popup" data-gall="myGallery"> <i
                            class="fas fa-expand"></i></a>
                    <div class="projects-content">
                ...
                <div class="project-item">
                    ...
                    <div class="overlay"></div>
                    <a href="img/project-4.jpg" class="view-icon img-popup" data-gall="myGallery"> <i
                            class="fas fa-expand"></i></a>
                    <div class="projects-content">
                        <a href="projects.html" class="category">Architecture</a>
                ...
                <div class="project-item">
                    ...
                    <div class="overlay"></div>
                    <a href="img/project-5.jpg" class="view-icon img-popup" data-gall="myGallery"> <i
                            class="fas fa-expand"></i></a>
                    <div class="projects-content">
                        <a href="projects.html" class="category">Design</a>
    ...
    <section class="cta-section padding">
        <div class="container">
            <div class="cta-content text-center">
                ...
                <p>We offer a fully integrated service that complements the architectural <br> concept, we ensure all
                    projects.</p>
